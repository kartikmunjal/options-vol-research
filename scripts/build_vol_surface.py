...
from src.data.fetch import fetch_options_chain, fetch_historical_prices, realized_vol
...
def main():
    ...
    log.info(f"Spot: ${spot:.2f} | r: {r:.2%} | RV-21d: {rv:.1%} | RV-5d: {rv_5d:.1%}")
    ...
    if vs.expiries:
        ...
        print(f"  VRP estimate:    {skew['atm_iv'] - rv:.1%}  (IV - RV-21d)")
        print("=" * 60)
